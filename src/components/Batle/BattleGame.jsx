...
const BattleGame = () => {
  ...
  const choices = [
    { id: 'abc123', name: 'MOSASAURUS', atk: 4, def: 2, image: 'https://i.ibb.co/prJRQ3LL/dino-00.jpg' },
    { id: 'def456', name: 'ALLOSAURUS', atk: 3, def: 2, image: 'https://i.ibb.co/q3f0rRbD/dino-07.jpg' },
    { id: 'ghi789', name: 'VELOCIRAPTORCITO', atk: 2, def: 2, image: 'https://i.ibb.co/0VdbZ0Qg/dino-04.jpg' },
    { id: 'jkl012', name: 'ATROCIRAPTOR', atk: 2, def: 3, image: 'https://i.ibb.co/b5js12W9/dino-12.jpg' },
    { id: 'mno345', name: 'PYRORAPTOR', atk: 2, def: 4, image: 'https://i.ibb.co/Ldph4GQ5/dino-06.jpg' },
    { id: 'pqr678', name: 'TRICERATOPS', atk: 3, def: 3, image: 'https://i.ibb.co/Fqg2kDbd/dino-02.jpg' },
    { id: 'stu901', name: 'SAURÓPODO', atk: 1, def: 4, image: 'https://i.ibb.co/nNF2HNth/dino-05.jpg' },
    { id: 'vwx234', name: 'VELOCIRAPTOR', atk: 3, def: 2, image: 'https://i.ibb.co/hbVrmVn/dino-01.jpg' },
    { id: 'yz0123', name: 'TIRANOSSAURO', atk: 4, def: 2, image: 'https://i.ibb.co/vCjgrNyp/dino-09.jpg' },
    { id: '456abc', name: 'THERIZINOSAURUS', atk: 2, def: 4, image: 'https://i.ibb.co/qYW4cd8m/dino-08.jpg' },
    { id: '789def', name: 'OVIRAPTOR', atk: 2, def: 2, image: 'https://i.ibb.co/FkJCg3sy/dino-11.jpg' },
    { id: '012ghi', name: 'MICRORAPTOR', atk: 2, def: 4, image: 'https://i.ibb.co/7tvypm7b/dino-03.jpg' }
  ];
  useEffect(() => {
    if (round > 0) {
      playRound();
